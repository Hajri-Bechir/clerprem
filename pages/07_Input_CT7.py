...
# This page is for sheet: CT7
SHEET_NAME = "CT7"
# Use a dedicated Excel file for CT7
EXCEL_FILE_PATH = r"C:/Users/White/Desktop/clerprem-project/data/CT7_data.xlsx"  # Dedicated file for CT7

st.set_page_config(page_title=f"Input: Ct7", page_icon="📝")
